...
export default function TabsPanel() {
	...
	const tabs = [
		...
		},
		{
			...
			label: "DBA",
			endpoint: "/api/dbas",
			fields: [{ name: "description", label: "Descripción del DBA" }],
		},
		{
			id: "competencias",
			label: "Competencias",
			endpoint: "/api/competencies",
			fields: [{ name: "name", label: "Descripción de competencias" }],
		},
		{
			id: "ejes",
			label: "Ejes Temáticos",
			endpoint: "/api/thematic-axes",
			fields: [{ name: "name", label: "Descripción de Eje Temático" }],
		},
		{
			id: "criterios",
			...
			fields: [
				{
					name: "description",
					label: "Descripción de Criterios de evaluación",
				},
			],
		},
		{
			...
			fields: [{ name: "name", label: "Descripción de aprendizajes" }],
		},
		{
			id: "actividades",
			label: "Actividades de profundización",
			endpoint: "/api/self-improvement-activities",
			fields: [
				{ name: "name", label: "Descripción de Act. de profundización" },
			],
		},
		{
			id: "recursos",
			...
			fields: [{ name: "name", label: "Nombre del Recurso" }],
		},
	];
